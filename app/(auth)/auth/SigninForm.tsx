...
export default function SignInPage() {
  ...
  // Avoid hydration mismatch by only rendering theme toggle after mounting
  useEffect(() => {
    setMounted(true);
  }, []);
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-black">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-900 rounded-xl shadow-lg">
        ...
        <div className="space-y-4">
          <Button
            variant="outline"
            className="w-full h-12 flex items-center justify-center space-x-2 border-2 dark:border-gray-700 dark:hover:bg-gray-800 dark:text-white"
